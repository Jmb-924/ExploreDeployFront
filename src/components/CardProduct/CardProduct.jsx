...
const CardProduct = ({ product, deleteProductoDef }) => {
   ...
   const [selectedBag, setSelectedBag] = useState(product?.bags[0]);
      ...
      <div className="card" onMouseLeave={() => [setTimeout(() => [setRotateCard(false)], 250), setTimeout(() => clearData(), 250)]}>
         <div className={`content-card ${rotateCard && "rotate-card"}`}>
            <div className="front-card">
               ...
               <Link className='redirect-view-content' to={`/Coffee/View-Coffee/${ReplaceSpaceTo(product?.marca, '-')}/${product?._id}`}>
